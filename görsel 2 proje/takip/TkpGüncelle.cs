...
namespace görsel_2_proje.takip
{
    public partial class TkpGuncelle : Form
    {
        ...
        private void CihazBGuncelle_Click(object sender, EventArgs e)
        {
            ...
            {
                byte sonuc;
                sonuc = sb.Guncelle("Teknik_Takip", "Takip_marka='" + sb.IlkHarfleriBuyut(marka.Text) + "', Takip_model='" + sb.IlkHarfleriBuyut(model.Text) + "', Takip_imei='" + imei.Text + "', Takip_serino='" + serino.Text + "'", "Takip_no='" + label8.Text + "'");
                if (sonuc == 1)
                {
        ...
        private void MusteriBGuncelle_Click(object sender, EventArgs e)
        {
            ...
            {
                byte sonuc;
                sonuc = sb.Guncelle("Teknik_Takip", "Takip_kisibilgi='" + sb.IlkHarfleriBuyut(adsoyad.Text) + "', Takip_kisiTel='" + telefon.Text + "'", "Takip_no='" + label8.Text + "'");
                if (sonuc == 1)
                {
